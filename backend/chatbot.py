...
def start_chat(model, selected_year, processed_data_dir, selected_user_names=None):
    """
...
"""
    ...
    # Removed the while loop for interactive chat as this will be handled by the API endpoint
    return chat # Return the chat session object

# Removed the interactive chat loop from here
# Removed the __main__ block as it's not needed for the API
